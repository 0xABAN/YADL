...
void mainImage(out vec4 o, vec2 C){
  ...
  float n=noise(vec2(uv.x*7.0,uv.y*16.0+t*0.25));
  float n2=noise(vec2(uv.x*19.0+3.0,uv.y*28.0-t*0.18));
  float n3=noise(vec2(uv.x*42.0,uv.y*36.0+t*0.4));
  float wobble=(n-0.5)*0.06+(n2-0.5)*0.045+(n3-0.5)*0.03;
  col=mix(col,vec3(0.0196),S(0.08+wobble,0.24+wobble,uv.y));
